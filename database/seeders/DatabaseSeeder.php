    ...
    public function run(): void
    {
        ...
        $posts = [
            [
                ...
                'categories' => json_encode(['Singles', 'Uncategorized', 'Rock']),
                'tags' => json_encode(['jazz', 'music', 'news', 'concerts']),
                'is_published' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'categories' => json_encode(['Typography', 'Uncategorized', 'Artistas']),
                'tags' => json_encode(['typography', 'design', 'articles']),
                'is_published' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'categories' => json_encode(['Music', 'Uncategorized', 'Conciertos']),
                'tags' => json_encode(['portrait', 'music', 'live', 'rock']),
                'is_published' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],

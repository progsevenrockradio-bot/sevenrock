...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('master_programs')) {
            DB::table('master_programs')
                ->where('caratula_url', 'like', '%sevenrockradio.shop%')
                ->update([
                    'caratula_url' => DB::raw("REPLACE(caratula_url, 'sevenrockradio.shop', 'sevenrockradio.com')"),
                ]);

            DB::table('master_programs')
                ->where('live_image_url', 'like', '%sevenrockradio.shop%')
                ->update([
                    'live_image_url' => DB::raw("REPLACE(live_image_url, 'sevenrockradio.shop', 'sevenrockradio.com')"),
                ]);
        }
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('master_programs')) {
            DB::table('master_programs')
                ->where('caratula_url', 'like', '%sevenrockradio.com%')
                ->update([
                    'caratula_url' => DB::raw("REPLACE(caratula_url, 'sevenrockradio.com', 'sevenrockradio.shop')"),
                ]);

            DB::table('master_programs')
                ->where('live_image_url', 'like', '%sevenrockradio.com%')
                ->update([
                    'live_image_url' => DB::raw("REPLACE(live_image_url, 'sevenrockradio.com', 'sevenrockradio.shop')"),
                ]);
        }

...
El archivo se subió correctamente al servidor de respaldo.
...
<td style="padding: 8px 0;">{{ (string) ($episode->radioboss_status ?? '') === 'radioboss_verified' || (bool) $episode->enviado_radioboss ? 'Verificado' : 'Pendiente' }}</td>
</tr>
<tr>
...
@if ($archiveItemUrl)
Puedes revisar el episodio en Archive.org: [Abrir Archive.org]({{ $archiveItemUrl }})
@endif

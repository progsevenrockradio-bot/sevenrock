<x-layouts.admin :title="'Audit trail - '.$themeSettings->site_name">
    <section class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8">
        ...
        <p class="mt-3 max-w-3xl text-[#9a9a9a]">
        ...
        <div class="mt-6 grid gap-4 md:grid-cols-4">
            <div class="border border-[#2b2b2b] bg-[rgba(0,0,0,.2)] p-4">
                <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Total</div>
                <div class="mt-2 text-2xl font-semibold text-[#e0e0e0]">{{ $stats['total'] }}</div>
            </div>
            <div class="border border-[#2b2b2b] bg-[rgba(0,0,0,.2)] p-4">
                <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Today</div>
                <div class="mt-2 text-2xl font-semibold text-[#e0e0e0]">{{ $stats['today'] }}</div>
            </div>
            <div class="border border-[#2b2b2b] bg-[rgba(0,0,0,.2)] p-4">
                <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Warnings</div>
                <div class="mt-2 text-2xl font-semibold text-[#ffcf7a]">{{ $stats['warnings'] }}</div>
            </div>
            <div class="border border-[#2b2b2b] bg-[rgba(0,0,0,.2)] p-4">
                <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Errors</div>
    ...
    <section class="mt-8 space-y-4">
            ...
            <article class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-5">
                <div class="flex flex-wrap items-start justify-between gap-4">
                    <div>
                        ...
                        <div class="mt-1 text-xs uppercase tracking-[.18em] text-[#9a9a9a]">
                    ...
                    <div class="text-right text-xs uppercase tracking-[.18em] text-[#9a9a9a]">
                ...
                <details class="mt-4 border border-[#2b2b2b] bg-[rgba(0,0,0,.22)] p-4">
                    ...
                    <div class="mt-4 grid gap-4 lg:grid-cols-2">
                        <div>
                            <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Request</div>
                        ...
                        <div>
                            <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Changes</div>
                        ...
                        <div>
                            <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Context</div>
                        ...
                        <div>
                            <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Response</div>
        ...
        @empty
            <p class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8 text-sm text-[#9a9a9a]">Todavía no hay entradas de auditoría.</p>
        @endforelse
    </section>

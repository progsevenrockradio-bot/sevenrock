<section class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8">
    ...
    <div class="mt-6 grid gap-6 xl:grid-cols-2">
        <div class="border border-[#2b2b2b] bg-[rgba(0,0,0,.18)] p-5">
            <label class="mb-3 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Archivo MP3</label>
            ...
            <div class="mt-4 space-y-2 border border-[#242424] bg-[#131313] p-4">
                <div class="text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">Estado de carga</div>
                ...
                <div class="flex items-center justify-between text-[11px] uppercase tracking-[.18em] text-[#9a9a9a]">
        ...
        <div class="border border-[#2b2b2b] bg-[rgba(0,0,0,.18)] p-5">
            <div class="flex items-center justify-between gap-3">
                <label class="block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Carátula / imagen del episodio</label>
            ...
            <div class="mt-4 grid gap-5 md:grid-cols-2">
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">URL de imagen</label>
                ...
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Archivo de imagen</label>

            ...
            <table class="w-full min-w-[1120px] text-left text-sm">
                <thead class="text-xs uppercase tracking-[.18em] text-[#7b7b7b]">
                    <tr>
                        ...
                        <th class="py-3 pr-4">Abiertos</th>
                        <th class="py-3 pr-4">Respondidos</th>
                ...
                <tbody>
                    @forelse ($campaigns as $campaign)
                        <tr class="border-t border-[#242424]">
                            ...
                            <td class="py-4 pr-4 text-[#9f9f9f]">{{ $campaign->program?->program_code ?: 'Todos' }}</td>
                            ...
                            <td class="py-4 pr-4 text-[#9f9f9f]">{{ $campaign->opened_count }}</td>
                            <td class="py-4 pr-4 text-[#9f9f9f]">{{ $campaign->responded_count }}</td>

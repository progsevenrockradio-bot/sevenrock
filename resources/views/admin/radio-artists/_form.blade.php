...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <div x-data="imageHelper('{{ old('image_path', $bandProfile->image_path) }}')">
        ...
        <div class="mt-1.5 p-3 rounded bg-[#16161a] border border-white/5 text-[11px] text-[#8f877d] space-y-1.5">
            <p><strong>¿Cómo subir la imagen?</strong> Sube tu archivo gratis en <a href="https://imgbb.com" target="_blank" rel="noreferrer" class="text-[#a855f7] hover:underline">ImgBB</a> o <a href="https://postimages.org" target="_blank" rel="noreferrer" class="text-[#a855f7] hover:underline">Postimages</a> y copia el <strong>Enlace directo</strong> (debe terminar en <code>.jpg</code>, <code>.png</code> o <code>.webp</code>).</p>

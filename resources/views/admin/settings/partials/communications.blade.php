<section class="space-y-6">
    ...
    <div class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm leading-7 text-[#9a9a9a]">Aquí se agrupan los textos de contacto, redes sociales, ajustes de notificaciones activas y automatización de correo por IA.</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-6 xl:grid-cols-2">
        ...
        <section class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8">
            ...
            <div class="space-y-5">
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['contact_form_title_label'] }}</label>
                ...
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['contact_info_title_label'] }}</label>
                ...
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['contact_description_label'] }}</label>
        ...
        <section class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8">
            ...
            <div class="space-y-5">
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['address_label'] }}</label>
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['contact_phone_primary_label'] }}</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['contact_phone_secondary_label'] }}</label>
    ...
    <div class="grid gap-6 xl:grid-cols-2">
        ...
        <section class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['facebook_label'] }}</label>
                ...
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['instagram_label'] }}</label>
                ...
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['youtube_label'] }}</label>
                ...
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['tiktok_label'] }}</label>
                ...
                <div class="md:col-span-2 border-t border-[#2b2b2b] pt-4 mt-2">
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['x_label'] }}</label>
        ...
        <section class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8 flex flex-col justify-between">
            <div>
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['contact_email_label'] }}</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['notification_email_label'] }}</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['notification_copy_email_label'] }}</label>
                        ...
                        <p class="mt-1 text-[10px] text-[#9a9a9a]">Copia global usada por defecto en los programas.</p>
                        @error('notification_copy_email')<p class="mt-2 text-xs text-[#ff9e9e]">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['notification_from_email_label'] }}</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['notification_reply_to_email_label'] }}</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">{{ $admin['notification_mailer_label'] }}</label>
                        ...
                        <p class="mt-1 text-[10px] text-[#9a9a9a]">Sobrescribe el mailer predeterminado.</p>
            ...
            <div class="mt-6 border border-[#2b2b2b] bg-[rgba(0,0,0,.2)] p-4 rounded-lg">
                ...
                <div class="grid gap-3 grid-cols-2 md:grid-cols-3 text-xs">
                    <div class="p-2 bg-[rgba(16,16,18,.5)] border border-[#2b2b2b] rounded">
                        <span class="block text-[9px] uppercase tracking-wider text-[#9a9a9a]">Destinatario Activo</span>
                        <span class="font-mono text-[#e0e0e0] break-all block mt-1">{{ $activeNotificationState['primary'] ?? 'No definido' }}</span>
                    </div>
                    <div class="p-2 bg-[rgba(16,16,18,.5)] border border-[#2b2b2b] rounded">
                        <span class="block text-[9px] uppercase tracking-wider text-[#9a9a9a]">Copia Activa</span>
                        <span class="font-mono text-[#e0e0e0] break-all block mt-1">{{ $activeNotificationState['copy'] ?? 'No definido' }}</span>
                    </div>
                    <div class="p-2 bg-[rgba(16,16,18,.5)] border border-[#2b2b2b] rounded">
                        <span class="block text-[9px] uppercase tracking-wider text-[#9a9a9a]">Remitente Activo</span>
                        <span class="font-mono text-[#e0e0e0] break-all block mt-1">{{ $activeNotificationState['from'] ?? 'No definido' }}</span>
                    </div>
                    <div class="p-2 bg-[rgba(16,16,18,.5)] border border-[#2b2b2b] rounded">
                        <span class="block text-[9px] uppercase tracking-wider text-[#9a9a9a]">Reply-To Activo</span>
                    ...
                    <div class="p-2 bg-[rgba(16,16,18,.5)] border border-[#2b2b2b] rounded md:col-span-2">
                        <span class="block text-[9px] uppercase tracking-wider text-[#9a9a9a]">Mailer Configurado</span>
    ...
    <div class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8">
        ...
        <p class="text-sm text-[#9a9a9a] mb-6">Configura las opciones inteligentes y credenciales de IA para procesar los lanzamientos recibidos por email.</p>
        ...
        <div class="grid gap-6 md:grid-cols-2 mb-6">
            ...
            <div class="flex items-center justify-between p-4 border border-[#2b2b2b] bg-[rgba(0,0,0,.15)] rounded-lg">
                <div class="pr-4">
                    ...
                    <span class="text-[10px] text-[#9a9a9a] block mt-1">Habilita o pausa la lectura automática de la bandeja de entrada IMAP.</span>
                </div>
            ...
            <div class="flex items-center justify-between p-4 border border-[#2b2b2b] bg-[rgba(0,0,0,.15)] rounded-lg">
                <div class="pr-4">
                    ...
                    <span class="text-[10px] text-[#9a9a9a] block mt-1">Publica directamente en "Activo" o guarda en "Borrador" para revisión manual.</span>
                </div>
        ...
        <div class="grid gap-5 md:grid-cols-2">
            ...
            <div>
                <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Relevancia Mínima de Correo (Filtro Inteligente Gemini)</label>
                ...
                <p class="mt-2 text-[10px] text-[#9a9a9a]">Elige el umbral de descarte automático que realiza Gemini IA (1 a 5).</p>
                @error('email_min_importance')<p class="mt-2 text-xs text-[#ff9e9e]">{{ $message }}</p>@enderror
            </div>

            <!-- Whitelist de remitentes -->
            <div>
                <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Lista Blanca de Remitentes (Whitelist)</label>
                ...
                <p class="mt-2 text-[10px] text-[#9a9a9a]">Ingresa correos o dominios separados por comas. Evadirán el filtro de relevancia mínima.</p>
            ...
            <div>
                ...
                <p class="mt-2 text-[10px] text-[#9a9a9a]">Número máximo de noticias creadas automáticamente por día.</p>
            ...
            <div class="md:col-span-2 border-t border-[#2b2b2b] pt-5 mt-3">
                <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Portada Predeterminada de Respaldo (Backup)</label>
                <div class="flex flex-col sm:flex-row gap-4 items-center p-4 border border-[#2b2b2b] bg-[rgba(0,0,0,.15)] rounded">
                    @if($settings->email_default_cover_path)
                        <div class="relative group shrink-0 border border-[#3b3b3b] p-2 bg-[rgba(0,0,0,.4)] rounded">
                            ...
                            <div class="text-[9px] text-center mt-1 text-[#9a9a9a] font-mono truncate max-w-[64px]">{{ basename($settings->email_default_cover_path) }}</div>
                        </div>
                    @else
                        <div class="h-16 w-16 bg-[#101012] border border-[#2b2b2b] flex items-center justify-center text-[10px] text-[#9a9a9a] uppercase text-center p-1 leading-tight rounded shrink-0">Sin imagen</div>
                    @endif
                    <div class="flex-1 w-full">
                        ...
                        <p class="mt-2 text-[10px] text-[#9a9a9a]">Se usa de respaldo si el email del artista no tiene adjuntos grandes de portada. Máx 4MB.</p>
                    </div>
                </div>
    ...
    <section class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8">
        ...
        <div class="space-y-5">
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Color de Fondo del Correo</label>
                    ...
                    <p class="mt-2 text-[10px] text-[#9a9a9a]">Fondo del email enviado. Por defecto oscuro: #0c0c0e.</p>
                </div>
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Título de Cabecera (Servidor de Podcast)</label>
                    ...
                    <p class="mt-2 text-[10px] text-[#9a9a9a]">Sustituye el texto "Archive.org verificado" en los asuntos/cabeceras.</p>
                </div>
            </div>

            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Etiqueta de Destino: Streaming (RB)</label>
                ...
                <div>
                    <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Etiqueta de Destino: Podcast (Archive)</label>
            ...
            <div>
                <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Texto de Cierre (Footer)</label>
                ...
                <p class="mt-2 text-[10px] text-[#9a9a9a]">Reemplaza el texto final que invitaba a revisar el episodio en archive.org.</p>
            </div>
            ...
            <div class="border-t border-[#2b2b2b] pt-5 mt-5">
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Asunto (Nuevo Lanzamiento)</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Cabecera (Nuevo Lanzamiento)</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Asunto (Entrada de Blog)</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Cabecera (Entrada de Blog)</label>
            ...
            <div class="border-t border-[#2b2b2b] pt-5 mt-5 bg-[rgba(0,0,0,0.15)] p-4 rounded border border-[#222]">
                <label class="mb-3 block text-xs uppercase tracking-[.18em] text-[#9a9a9a] font-bold text-lucille-accent">✉️ Probar Plantilla de Email</label>
                <div class="grid gap-3 sm:grid-cols-3">
                    <div>
                        <label class="mb-1 block text-[9px] uppercase tracking-[.14em] text-[#9a9a9a]">Seleccionar Plantilla</label>
                    ...
                    <div class="sm:col-span-2">
                        <label class="mb-1 block text-[9px] uppercase tracking-[.14em] text-[#9a9a9a]">Destinatario de Prueba</label>
                ...
                <p class="mt-2.5 text-[10px] text-[#9a9a9a]">Elige la plantilla de notificación y el correo a donde deseas que llegue para comprobar los asuntos, colores y cabeceras dinámicas.</p>
            </div>
        </div>
    </section>
</section>

...
<div class="grid gap-5 md:grid-cols-2">
    <div>
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Slug</label>
        <input name="slug" value="{{ old('slug', $song->slug) }}" class="lucille-product-field w-full">
    </div>
    <div>
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Published At</label>
    ...
    <div>
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Title</label>
        <input name="title" value="{{ old('title', $song->title) }}" class="lucille-product-field w-full">
    </div>
    <div>
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Artist</label>
        <input name="artist" value="{{ old('artist', $song->artist) }}" class="lucille-product-field w-full">
    </div>
    <div>
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Radio Artist</label>
    ...
    <div>
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Album</label>
        <input name="album" value="{{ old('album', $song->album) }}" class="lucille-product-field w-full">
    </div>
    <div>
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Program</label>
    ...
    <div>
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Duration Seconds</label>
    ...
    <div class="md:col-span-2">
        <label class="mb-2 block text-xs uppercase tracking-[.18em] text-[#9a9a9a]">Social Links</label>
    ...
    <div class="md:col-span-2 flex items-center gap-3">
        ...
        <label class="text-sm text-[#9a9a9a]">Live track</label>
    </div>
</div>

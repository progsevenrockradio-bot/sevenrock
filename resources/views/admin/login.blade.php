<x-layouts.admin :title="$themeAppearance['admin_texts']['admin_login_title'].' - '.$themeSettings->site_name">
    <div class="mx-auto mt-10 max-w-xl">
        <div class="border border-[#2b2b2b] bg-[rgba(16,16,18,.88)] p-8 md:p-10">
            ...
            <p class="mt-3 text-sm text-[#9a9a9a]">{{ $themeAppearance['admin_texts']['admin_login_copy'] }}</p>
            ...
            <form action="{{ route('admin.login.store') }}" method="POST" class="mt-8 space-y-6">
                ...
                <label class="flex items-center gap-2 text-sm text-[#9a9a9a]">
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <a href="{{ route('admin.password.request') }}" class="text-xs text-[#9a9a9a] transition hover:text-lucille-accent">

...
@endphp
                ...
                <section class="radio-player-popup-drawer overflow-hidden rounded-[22px] border border-white/10" x-show="panelOpen" x-transition.opacity>
                    ...
                    <div class="radio-player-popup-drawer-body">
                        ...
                        <div x-show="activeTab === 'band'">
                            ...
                            <p class="radio-player-popup-section-text" x-text="track.band_info || 'Buscando información de banda...'"></p>
                        </div>
    ...
    @else
                    ...
                    <template x-if="!bandInfoLoading">
                        <div class="radio-modal-content radio-modal-content--band">
                            <div class="radio-modal-header radio-modal-header--band">
                                <div class="radio-modal-media">
                                        <img class="radio-modal-cover radio-modal-cover--band"
                                ...
                                <div class="radio-modal-copy">
                                    <h3 class="radio-modal-title" data-player-band-title x-text="bandPanel.title || track.title || ''"></h3>
                                    <p class="radio-modal-artist" data-player-band-artist x-text="bandPanel.artist || track.artist || ''"></p>
                                    <p x-show="(bandPanel.foundedLabel || track.band_founded_label)" class="radio-modal-label" x-text="bandPanel.foundedLabel || track.band_founded_label"></p>
                                    <div x-show="bandPanel.country || track.band_country || bandPanel.genre || track.band_genre || bandPanel.membersCount || track.band_members_count || bandPanel.status || track.band_status" class="radio-modal-tags">
                                        <span x-show="bandPanel.country || track.band_country" class="radio-modal-tag" x-text="'🌍 ' + (bandPanel.country || track.band_country || '')"></span>
                                        <span x-show="bandPanel.genre || track.band_genre" class="radio-modal-tag" x-text="'🎵 ' + (bandPanel.genre || track.band_genre || '')"></span>
                                        <span x-show="bandPanel.membersCount || track.band_members_count" class="radio-modal-tag" x-text="'👥 ' + ((bandPanel.membersCount ?? track.band_members_count) || 0) + ' miembros'"></span>
                                        <span x-show="bandPanel.status || track.band_status" class="radio-modal-tag" x-text="(() => { const status = bandPanel.status || track.band_status || ''; return status === 'active' ? '✅ Activo' : (status === 'on_hold' ? '⏸ En pausa' : (status === 'disbanded' ? '❌ Disuelto' : status)); })()"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="radio-modal-body">
                                <div
                                    ...
                                    x-cloak
                                    class="radio-modal-scroll"
                                >
                                    <section class="radio-modal-card">
                                        <h4 class="radio-modal-card-title">Biografía / información</h4>
                                        <p data-player-band-info class="radio-modal-text" x-text="resumenBio || 'Buscando información de banda...'"></p>

                                        <div x-show="bandPanel.logo || track.band_logo || bandLinks().length" class="radio-modal-links">
                                    ...
                                    <section x-show="Array.isArray(track.band_members) && track.band_members.length > 0" class="radio-modal-card">
                                ...
                                >
                                    <section class="radio-modal-card">
                                        ...
                                        <p class="radio-modal-text radio-modal-text--lyrics" x-text="track.lyrics && track.lyrics.trim() ? track.lyrics : 'No hay letra disponible para esta canción'"></p>
                                    </section>
                                </div>
                            </div>
                        </div>
        ...
        >
            ...
            <div class="radio-player-body radio-player-body--dock">
                <section class="radio-player-now radio-player-now--dock">
                    ...
                    <div class="radio-player-now-copy radio-player-now-copy--dock">

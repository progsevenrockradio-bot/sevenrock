...
<section
    ...
    x-init="init"
    class="relative min-h-[60dvh] overflow-hidden sm:min-h-[70svh] md:min-h-[960px] xl:min-h-[868px]"
>
    ...
    <div class="relative z-10 mx-auto flex min-h-[60dvh] max-w-[1240px] items-end justify-end px-6 pt-[10dvh] pb-[4dvh] text-right sm:min-h-[70svh] md:min-h-[960px] md:pt-0 md:pb-6 lg:px-10 xl:min-h-[868px]">

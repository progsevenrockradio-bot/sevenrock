...
>
    ...
    >
        ...
        <div class="hidden items-center gap-4 xl:gap-6 border-l border-white/10 pl-4 xl:pl-6 lg:flex">
            ...
            <a href="{{ route('app.download') }}" class="ml-2 flex items-center gap-2 rounded-full bg-lucille-accent px-4 py-2 text-[11px] xl:text-xs font-display font-bold uppercase tracking-wider text-white shadow-lg shadow-lucille-accent/30 transition-all hover:scale-105 hover:bg-opacity-90 hover:shadow-lucille-accent/50" aria-label="Descargar la aplicación de la radio" title="Descargar App">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                    <polyline points="7 10 12 15 17 10"></polyline>
                    <line x1="12" y1="15" x2="12" y2="3"></line>
                </svg>
                <span class="hidden xl:inline">Descargar App</span>
                <span class="inline xl:hidden">Descargar</span>
            </a>
        </div>
    </div>

            ...
            <div class="flex-1 overflow-y-auto px-4 py-6 space-y-6">
                ...
                <div>
                    ...
                    <ul class="mt-2 space-y-1">
                        ...
                        @endrole
                        <li>
                            <a href="{{ route('admin.media-kit.form') }}" class="flex items-center gap-3 px-3 py-2 text-xs rounded transition-colors {{ request()->routeIs('admin.media-kit.*') ? 'bg-[rgba(255,255,255,.05)] text-[var(--lucille-accent)] font-medium border-l-2 border-[var(--lucille-accent)]' : 'text-gray-300 hover:bg-[rgba(255,255,255,.02)] hover:text-white' }}">
                                <svg class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                                <span>Media Kit</span>
                            </a>
                        </li>
                ...
                <div>
                    ...
                    <ul class="mt-2 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('admin.direct-email.create') }}" class="flex items-center gap-3 px-3 py-2 text-xs rounded transition-colors {{ request()->routeIs('admin.direct-email.*') ? 'bg-[rgba(255,255,255,.05)] text-[var(--lucille-accent)] font-medium border-l-2 border-[var(--lucille-accent)]' : 'text-gray-300 hover:bg-[rgba(255,255,255,.02)] hover:text-white' }}">
                                <svg class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
    ...
    <script>
        (() => {
            ...
            const sections = [
                ...
                @endrole
                { name: 'Media Kit', url: '{{ route("admin.media-kit.form") }}', category: 'General' },

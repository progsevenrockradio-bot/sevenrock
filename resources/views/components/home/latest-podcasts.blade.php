    ...
    <article class="home-panel overflow-hidden">
        <div class="home-podcast-feature">
            <div class="home-podcast-cover">
                <img src="{{ asset($podcasts['featured']['image']) }}" alt="{{ $podcasts['featured']['title'] }}" class="h-full w-full object-cover">
            </div>
            ...
            <div class="home-podcast-copy">
                ...
                <a href="#" class="lucille-button-solid mt-7">Escuchar</a>
            </div>
        </div>
    </article>
        ...
        @foreach ($podcasts['episodes'] as $episode)
            <article class="home-podcast-row group flex-col md:flex-row">
                <div class="home-podcast-row-media">
                    <img src="{{ asset($episode['image']) }}" alt="{{ $episode['title'] }}" class="h-full w-full object-cover transition duration-500 group-hover:scale-[1.03]">
                </div>

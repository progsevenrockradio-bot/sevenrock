<x-layouts.site title="Reportar Persona Desaparecida - {{ $themeSettings->site_name ?? 'Seven Rock Radio' }}" :showPlayer="false" :showSocialFlyout="false">
            ...
            <form action="{{ route('missing-persons.store') }}" method="POST" enctype="multipart/form-data" class="bg-[#121212] border border-white/5 p-8 md:p-12 rounded-2xl shadow-2xl">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="hospital_admitted_to" value="{{ old('hospital_admitted_to') }}" class="lucille-field w-full" placeholder="Ej. Hospital Domingo Luciani">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="text" name="service_provided" value="{{ old('service_provided') }}" class="lucille-field w-full" placeholder="Ej. Cirugía General, Traumatología...">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_update" value="{{ old('date_update') }}" class="lucille-field w-full bg-[#1a1a1a]">

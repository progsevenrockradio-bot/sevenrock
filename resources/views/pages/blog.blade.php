    ...
    <section>
        <div class="lucille-content-box">
            ...
            @if ($posts instanceof \Illuminate\Pagination\LengthAwarePaginator)
                ...
                <nav class="mt-14 flex flex-wrap items-center justify-center gap-2 border border-white/10 bg-[#050505f5] px-4 py-4 shadow-[0_28px_70px_rgba(0,0,0,.55)] md:px-6 md:py-5" aria-label="Paginación del blog">
